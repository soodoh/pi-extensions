---
description: Write a plan artifact and submit it through the pi-workflows Plannotator event gate.
...
Explore the codebase enough to write an implementation-ready markdown plan for `$ARGUMENTS`.
